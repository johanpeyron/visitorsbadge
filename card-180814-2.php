  ...
  <div class="container">
			...
			<div class="card" style="width: 400px;">
					...
					<div class="container-fluid">
							<div class="row">
									<div class="col-8 mt-1"><img class="card-img-top" src="<?php echo $post['image_url']; ?>"></div>
									<div class="col-4" id="qrcode">
									<!-- <img class="float-left" src="public/images/logo-lexicon.gif" alt="" width="58" height="20"> -->
									<img class=" mt-1 mb-1" src="public/images/logo-lexicon.gif" alt="" width="58" height="20">
									</div>
							</div>
						<div class="card-body">
